...
const _FieldName = "SKUCapacityStatusGroupInstance TypeLocationOperating SystemPre Installed S/WProduct FamilyserviceCodeTenancyusageTypeVolume API NameVolume TypeStorage ClassAccess TypeThroughput ClassCache EngineDatabase EngineDatabase EditionDeployment OptionLicense ModelFile system typeStorage typeThroughput capacityDeployment optionCurrencyPricePerUnitStartingRangeTermTypeUnitLeaseContractLengthPurchaseOptionStorage MediaPriceDescription"
...
var _FieldNameToValueMap = map[string]Field{
	...
	_FieldName[365:384]: LeaseContractLength,
	_FieldLowerName[365:384]: LeaseContractLength,
	_FieldName[384:398]: PurchaseOption,
	_FieldLowerName[384:398]: PurchaseOption,
	_FieldName[398:411]: StorageMedia,
	_FieldLowerName[398:411]: StorageMedia,
	_FieldName[411:427]: PriceDescription,
	_FieldLowerName[411:427]: PriceDescription,
}
