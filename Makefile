...
docker-build:
	...
	docker build -f  docker/SummarizerWorkerDockerfile . -t registry.digitalocean.com/keibi/summarizer-worker:0.0.1
...
docker-push:
	...
	docker push registry.digitalocean.com/keibi/summarizer-worker:0.0.1
