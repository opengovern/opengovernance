...
docker-build:
	...
	docker build -f  docker/SteampipeAWSComplianceDockerfile . -t registry.digitalocean.com/keibi/steampipe-mod-aws-compliance:0.0.1
	docker build -f  docker/SteampipeAzureComplianceDockerfile . -t registry.digitalocean.com/keibi/steampipe-mod-azure-compliance:0.0.1
...
docker-push:
	...
	docker push registry.digitalocean.com/keibi/steampipe-mod-aws-compliance:0.0.1
	docker push registry.digitalocean.com/keibi/steampipe-mod-azure-compliance:0.0.1
...
podman-build:
	...
	podman build -f  docker/SteampipeAWSComplianceDockerfile . -t registry.digitalocean.com/keibi/steampipe-mod-aws-compliance:0.0.1
	podman build -f  docker/SteampipeAzureComplianceDockerfile . -t registry.digitalocean.com/keibi/steampipe-mod-azure-compliance:0.0.1
...
podman-push:
	...
	podman push registry.digitalocean.com/keibi/steampipe-mod-aws-compliance:0.0.1
	podman push registry.digitalocean.com/keibi/steampipe-mod-azure-compliance:0.0.1
