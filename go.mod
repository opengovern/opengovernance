...
require (
	...
	gitlab.com/keibiengine/steampipe-plugin-aws v0.0.0-20220811114210-cf233ab7581e
	gitlab.com/keibiengine/steampipe-plugin-azure v0.23.2-0.20220822130029-99d19823cf5e
