...
require (
	...
	github.com/kaytu-io/kaytu v0.14.0-rc.0.0.20240619114201-51f5733d10b6 // indirect
	github.com/kaytu-io/plugin-gcp v0.0.0-20240701102923-ed9a22d0cc57 // indirect
