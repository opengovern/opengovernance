...
require (
	...
	github.com/opengovern/og-aws-describer v0.59.11
	github.com/opengovern/og-azure-describer v0.37.11
	github.com/opengovern/og-util v1.0.5-0.20241028151101-3f20bdec1039
