...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/inventory/api/v2/services/composition/{key}": {
            "get": {
                "security": [
                    {
                        "BearerToken": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.ListServiceCostCompositionResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/gitlab_com_keibiengine_keibi-engine_pkg_describe_api.EvaluateStack"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_describe_api.CreateStackRequest": {
            "type": "object",
            "properties": {
                "resources": {
                    "type": "array",
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_describe_api.EvaluateStack": {
            "type": "object",
            "required": [
                "benchmarks"
            ],
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.ListServiceCostCompositionResponse": {
            "type": "object",
            "properties": {
                "others": {
                    "type": "number"
