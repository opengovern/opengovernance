...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.GetRoleBindingsResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.GetCredsForJobRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.GetCredsForJobResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.ChangeWorkspaceNameRequest"
                        }
                    }
                ],
                "responses": {}
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.ChangeWorkspaceOrganizationRequest"
                        }
                    }
                ],
                "responses": {}
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.ChangeWorkspaceTierRequest"
                        }
                    }
                ],
                "responses": {}
    ...
    "definitions": {
        ...
        "api.ChangeWorkspaceNameRequest": {
            "type": "object",
            "properties": {
                "newName": {
                    "type": "string"
        ...
        "api.ChangeWorkspaceOrganizationRequest": {
            "type": "object",
            "properties": {
                "newOrgID": {
                    "type": "integer"
        ...
        "api.ChangeWorkspaceTierRequest": {
            "type": "object",
            "properties": {
                "newName": {
                    "type": "string"
