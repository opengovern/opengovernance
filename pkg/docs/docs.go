...
const docTemplate = `{
        ...
        "/inventory/api/v2/metadata/services": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter by cost support",
                        "name": "costSupport",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.ListResourceTypesResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.FilterCloudResourceType"
                        }
                    }
                }
            }
        ...
        "/inventory/api/v2/services/summary": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "filter: minimum spent amount for the service in the specified time",
                        "name": "minSpent",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.FilterCloudResourceType": {
            "type": "object",
            "properties": {
                "connector": {
                    "$ref": "#/definitions/source.Type"
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.FilterType": {
            "type": "string",
            "enum": [
                "cloudResourceType",
                "cost",
            ...
            "x-enum-varnames": [
                "FilterTypeCloudResourceType",
                "FilterTypeCost",
                "FilterTypeInsightMetric"
            ]
        },
