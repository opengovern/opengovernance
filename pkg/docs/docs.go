...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/alerting/api/action/delete/{actionId}": {
            "delete": {
                "security": [
                    {
                        "BearerToken": []
        ...
        "/alerting/api/rule/Delete/{ruleId}": {
            "delete": {
                "security": [
                    {
                        "BearerToken": []
    ...
    "definitions": {
        ...
        "github_com_kaytu-io_kaytu-engine_pkg_alerting_api.ApiAction": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string"
        ...
        "github_com_kaytu-io_kaytu-engine_pkg_alerting_api.ApiRule": {
            "type": "object",
            "properties": {
                "action_id": {
                    "type": "integer"
