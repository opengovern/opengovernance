...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/compliance/api/v1/insight/peer": {
            "get": {
                "description": "Listing insights",
                "produces": [
                    "application/json"
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/gitlab_com_keibiengine_keibi-engine_pkg_compliance_api.InsightPeerGroup"
                            }
                        }
                    }
                }
        ...
        "/compliance/api/v1/insight/peer/{peerGroupId}": {
            "get": {
        ...
        "/inventory/api/v2/resources/composition": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "How many top categories to return. The rest will be aggregated into Others.",
                        "name": "top",
                        "in": "query",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_compliance_api.Insight": {
            ...
            "properties": {
                ...
                "labels": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gitlab_com_keibiengine_keibi-engine_pkg_compliance_api.InsightTag"
                    }
                },
                "links": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gitlab_com_keibiengine_keibi-engine_pkg_compliance_api.InsightLink"
                    }
                },
                "logoURL": {
                    "type": "string"
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_compliance_api.InsightLink": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_compliance_api.InsightPeerGroup": {
            "type": "object",
            "properties": {
                "category": {
                    "type": "string"
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_compliance_api.InsightTag": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.CategoryNode": {
            ...
            "properties": {
                ...
                "cost": {
                    "description": "The aggregation of all the services costs",
                    "type": "object",
                    "additionalProperties": {
                ...
                "filters": {
                    "description": "List of Filters associated with this Category",
                    "type": "array",
                    "items": {}
                },
                "resourceCount": {
                    "description": "Number of Resources of the category",
                    "type": "integer"
                },
                "resourceCountChange": {
                    "type": "number"
                ...
                "subcategories": {
                    "description": "Subcategories sorted by ResourceCount [resources/category, ]",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.CategoryNode"
                    }
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.InsightTag": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "gitlab_com_keibiengine_keibi-engine_pkg_inventory_api.Query": {
            "type": "object",
            "properties": {
                "connector": {
                    "type": "string"
