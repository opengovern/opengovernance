...
var resourceTypeToDescriber = map[string]ResourceDescriber{
	...
	"Microsoft.Compute/disksreadops":                           DescribeBySubscription(describer.ComputeDiskReadOps),
	"Microsoft.Compute/disksreadopsdaily":                      DescribeBySubscription(describer.ComputeDiskReadOpsDaily),
	"Microsoft.Compute/disksreadopshourly":                     DescribeBySubscription(describer.ComputeDiskReadOpsHourly),
	"Microsoft.Compute/diskswriteops":                          DescribeBySubscription(describer.ComputeDiskWriteOps),
	"Microsoft.Compute/diskswriteopsdaily":                     DescribeBySubscription(describer.ComputeDiskWriteOpsDaily),
	"Microsoft.Compute/diskswriteopshourly":                    DescribeBySubscription(describer.ComputeDiskWriteOpsHourly),
	...
	"Microsoft.Compute/resourceSku":                            DescribeBySubscription(describer.ComputeResourceSKU),
	"Microsoft.Compute/virtualMachineScaleSets":                DescribeBySubscription(describer.ComputeVirtualMachineScaleSet),
	"Microsoft.Compute/virtualMachineScaleSetNetworkInterface": DescribeBySubscription(describer.ComputeVirtualMachineScaleSetNetworkInterface),
	"Microsoft.Compute/virtualMachineScaleSetsVm":              DescribeBySubscription(describer.ComputeVirtualMachineScaleSetVm),
	"Microsoft.Compute/virtualMachines":                        DescribeBySubscription(describer.ComputeVirtualMachine),
	"Microsoft.Compute/virtualMachineCpuUtilization":           DescribeBySubscription(describer.ComputeVirtualMachineCpuUtilization),
	"Microsoft.Compute/virtualMachineCpuUtilizationDaily":      DescribeBySubscription(describer.ComputeVirtualMachineCpuUtilizationDaily),
	"Microsoft.Compute/virtualMachineCpuUtilizationHourly":     DescribeBySubscription(describer.ComputeVirtualMachineCpuUtilizationHourly),
	...
	"Microsoft.DataFactory/factoriesDatasets":                  DescribeBySubscription(describer.DataFactoryDataset),
	"Microsoft.DataFactory/factoriesPipelines":                 DescribeBySubscription(describer.DataFactoryPipeline),
	...
	"Microsoft.Devices/iotHubDpses":                            DescribeBySubscription(describer.IOTHubDps),
	"Microsoft.DocumentDB/databaseAccounts":                    DescribeBySubscription(describer.CosmosdbAccount),
	"Microsoft.DocumentDB/databaseAccountsSqlDatabases":        DescribeBySubscription(describer.DocumentDBDatabaseAccountsSQLDatabase),
	"Microsoft.DocumentDB/databaseAccountsMongoDatabases":      DescribeBySubscription(describer.DocumentDBDatabaseAccountsMongoDatabase),
	...
	"Microsoft.KeyVault/deletedVaults":                         DescribeBySubscription(describer.DeletedVault),
	...
	"Microsoft.Sql/elasticPools":                               DescribeBySubscription(describer.SqlServerElasticPool),
	"Microsoft.Sql/virtualMachines":                            DescribeBySubscription(describer.SqlServerVirtualMachine),
	"Microsoft.Sql/flexibleServers":                            DescribeBySubscription(describer.SqlServerFlexibleServer),
	...
	"Microsoft.Storage/blobs":                                  DescribeBySubscription(describer.StorageBlob),
	"Microsoft.Storage/blobServives":                           DescribeBySubscription(describer.StorageBlobService),
	"Microsoft.Storage/queues":                                 DescribeBySubscription(describer.StorageQueue),
	"Microsoft.Storage/fileShares":                             DescribeBySubscription(describer.StorageFileShare),
	"Microsoft.Storage/tables":                                 DescribeBySubscription(describer.StorageTable),
	"Microsoft.Storage/tableServices":                          DescribeBySubscription(describer.StorageTableService),
	...
	"Microsoft.Web/plan":                                       DescribeBySubscription(describer.AppServicePlan),
	...
	"Microsoft.Security/automations":                           DescribeBySubscription(describer.SecurityCenterAutomation),
	"Microsoft.Security/subAssessments":                        DescribeBySubscription(describer.SecurityCenterSubAssessment),
	...
	"Microsoft.Kubernetes/connectedClusters": DescribeBySubscription(describer.HybridKubernetesConnectedCluster),
	...
	"Microsoft.Network/loadBalancers": DescribeBySubscription(describer.LoadBalancer),
	...
	"Microsoft.Network/publicIPAddresses": DescribeBySubscription(describer.PublicIPAddress),
	...
	"Microsoft.Network/natGateways":            DescribeBySubscription(describer.NatGateway),
	...
	"Microsoft.Authorization/policyDefinitions": DescribeBySubscription(describer.PolicyDefinition),
	//"Microsoft.Automation/automationAccounts":                   nil,
	//"Microsoft.Cdn/profiles":                                    nil,
	//"Microsoft.Cdn/profiles/endpoints":                          nil,
	"Microsoft.Compute/availabilitySets": DescribeBySubscription(describer.ComputeAvailabilitySet),
	//"Microsoft.Compute/cloudServices":                           nil,
	"Microsoft.Compute/diskEncryptionSets": DescribeBySubscription(describer.ComputeDiskEncryptionSet),
	...
	"Microsoft.LoadBalancer/backendAddressPools": DescribeBySubscription(describer.LoadBalancerBackendAddressPool),
	"Microsoft.LoadBalancer/natRules":            DescribeBySubscription(describer.LoadBalancerNatRule),
	"Microsoft.LoadBalancer/outboundRules":       DescribeBySubscription(describer.LoadBalancerOutboundRule),
	"Microsoft.LoadBalancer/probes":              DescribeBySubscription(describer.LoadBalancerProbe),
	"Microsoft.LoadBalancer/rules":               DescribeBySubscription(describer.LoadBalancerRule),
	"Microsoft.Management/groups":                DescribeBySubscription(describer.ManagementGroup),
	"Microsoft.Management/locks":                 DescribeBySubscription(describer.ManagementLock),
	"Microsoft.Resources/providers":              DescribeBySubscription(describer.ResourceProvider),
	"Microsoft.Resources/resourceGroups":         DescribeBySubscription(describer.ResourceGroup),
}
