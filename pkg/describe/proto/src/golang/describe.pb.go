...
var file_pkg_describe_proto_describe_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x73, 0x22, 0xa1, 0x02, 0x0a, 0x0b, 0x41, 0x57, 0x53, 0x52, 0x65, 0x73, 0x6f, 0x75,
	...
	0x6e, 0x69, 0x71, 0x75, 0x65, 0x49, 0x64, 0x22, 0x50, 0x0a, 0x0e, 0x41, 0x7a, 0x75, 0x72, 0x65,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x3e, 0x0a, 0x09, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x6b,
	0x61, 0x79, 0x74, 0x75, 0x2e, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x2e, 0x76, 0x31,
	0x2e, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x09,
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x22, 0xad, 0x02, 0x0a, 0x0d, 0x41, 0x7a,
...
var file_pkg_describe_proto_describe_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_pkg_describe_proto_describe_proto_depIdxs = []int32{
	...
	4, // 2: kaytu.describe.v1.AzureResources.resources:type_name -> kaytu.describe.v1.AzureResource
	0, // 3: kaytu.describe.v1.AzureResource.job:type_name -> kaytu.describe.v1.DescribeJob
	0, // 4: kaytu.describe.v1.DeliverResultRequest.describe_job:type_name -> kaytu.describe.v1.DescribeJob
	5, // 5: kaytu.describe.v1.DescribeService.DeliverResult:input_type -> kaytu.describe.v1.DeliverResultRequest
	1, // 6: kaytu.describe.v1.DescribeService.DeliverAWSResources:input_type -> kaytu.describe.v1.AWSResources
	3, // 7: kaytu.describe.v1.DescribeService.DeliverAzureResources:input_type -> kaytu.describe.v1.AzureResources
	6, // 8: kaytu.describe.v1.DescribeService.DeliverResult:output_type -> kaytu.describe.v1.ResponseOK
	6, // 9: kaytu.describe.v1.DescribeService.DeliverAWSResources:output_type -> kaytu.describe.v1.ResponseOK
	6, // 10: kaytu.describe.v1.DescribeService.DeliverAzureResources:output_type -> kaytu.describe.v1.ResponseOK
