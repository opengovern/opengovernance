...
var resourceTypeToDescriber = map[string]ResourceDescriber{
	...
	"AWS::Backup::Framework":         ParallelDescribeRegional(describer.BackupFramework),
	"AWS::Backup::LegalHold":         ParallelDescribeRegional(describer.BackupLegalHold),
	...
	"AWS::CloudFront::CachePolicy":           SequentialDescribeGlobal(describer.CloudFrontCachePolicy),
	"AWS::CloudFront::Function":              SequentialDescribeGlobal(describer.CloudFrontFunction),
	"AWS::CloudFront::OriginAccessIdentity":  SequentialDescribeGlobal(describer.CloudFrontOriginAccessIdentity),
	"AWS::CloudFront::OriginRequestPolicy":   SequentialDescribeGlobal(describer.CloudFrontOriginRequestPolicy),
	"AWS::CloudFront::ResponseHeadersPolicy": SequentialDescribeGlobal(describer.CloudFrontResponseHeadersPolicy),
	"AWS::CloudSearch::Domain":               SequentialDescribeGlobal(describer.CloudSearchDomain),
	"AWS::CloudTrail::Trail":                 ParallelDescribeRegional(describer.CloudTrailTrail),
	"AWS::CloudTrail::Channel":               ParallelDescribeRegional(describer.CloudTrailChannel),
	"AWS::CloudTrail::EventDataStore":        ParallelDescribeRegional(describer.CloudTrailEventDataStore),
	"AWS::CloudTrail::Import":                ParallelDescribeRegional(describer.CloudTrailImport),
	"AWS::CloudTrail::Query":                 ParallelDescribeRegional(describer.CloudTrailQuery),
	"AWS::CloudTrail::TrailEvent":            ParallelDescribeRegional(describer.CloudTrailTrailEvent),
	"AWS::CloudWatch::Alarm":                 ParallelDescribeRegional(describer.CloudWatchAlarm),
	"AWS::CloudWatch::LogEvent":              ParallelDescribeRegional(describer.CloudWatchLogEvent),
	"AWS::CloudWatch::LogResourcePolicy":     ParallelDescribeRegional(describer.CloudWatchLogsResourcePolicy),
	"AWS::CloudWatch::LogStream":             ParallelDescribeRegional(describer.CloudWatchLogStream),
	"AWS::CloudWatch::LogSubscriptionFilter": ParallelDescribeRegional(describer.CloudWatchLogsSubscriptionFilter),
	"AWS::CloudWatch::Metric":                ParallelDescribeRegional(describer.CloudWatchMetrics),
	...
	"AWS::CodeArtifact::Domain":             ParallelDescribeRegional(describer.CodeArtifactDomain),
	...
	"AWS::Config::AggregationAuthorization": ParallelDescribeRegional(describer.ConfigAggregateAuthorization),
	"AWS::Config::ConformancePack":          ParallelDescribeRegional(describer.ConfigConformancePack),
	"AWS::Config::Rule":                     ParallelDescribeRegional(describer.ConfigRule),
	"AWS::DAX::Cluster":                     ParallelDescribeRegional(describer.DAXCluster),
	"AWS::DAX::ParameterGroup":              ParallelDescribeRegional(describer.DAXParameterGroup),
	"AWS::DAX::Parameter":                   ParallelDescribeRegional(describer.DAXParameter),
	"AWS::DAX::SubnetGroup":                 ParallelDescribeRegional(describer.DAXSubnetGroup),
	...
	"AWS::DLM::LifecyclePolicy":             ParallelDescribeRegional(describer.DLMLifecyclePolicy),
	"AWS::DMS::ReplicationInstance":         ParallelDescribeRegional(describer.DMSReplicationInstance),
	"AWS::DocDB::Cluster":                   ParallelDescribeRegional(describer.DocDBCluster),
	//"AWS::DRS::RecoveryInstance":          ParallelDescribeRegional(describer.DRSRecoveryInstance), // DO NOT UNCOMMENT - Too much data and too slow for execution
	//"AWS::DRS::SourceServer":              ParallelDescribeRegional(describer.DRSSourceServer), // DO NOT UNCOMMENT - Too much data and too slow for execution
	//"AWS::DRS::Job":                       ParallelDescribeRegional(describer.DRSJob),              // DO NOT UNCOMMENT - Too much data and too slow for execution
	//"AWS::DRS::Snapshot":                  ParallelDescribeRegional(describer.DRSRecoverySnapshot), // DO NOT UNCOMMENT - Too much data and too slow for execution
	...
	"AWS::DynamoDb::TableExport":                                      ParallelDescribeRegional(describer.DynamoDbTableExport),
	"AWS::DynamoDb::MetricAccountProvisionedReadCapacityUtilization":  ParallelDescribeRegional(describer.DynamoDBMetricAccountProvisionedReadCapacityUtilization),
	"AWS::DynamoDb::MetricAccountProvisionedWriteCapacityUtilization": ParallelDescribeRegional(describer.DynamoDBMetricAccountProvisionedWriteCapacityUtilization),
	...
	"AWS::EC2::EbsVolumeMetricReadOps":                                ParallelDescribeRegional(describer.EbsVolumeMetricReadOps),
	"AWS::EC2::EbsVolumeMetricReadOpsDaily":                           ParallelDescribeRegional(describer.EbsVolumeMetricReadOpsDaily),
	"AWS::EC2::EbsVolumeMetricReadOpsHourly":                          ParallelDescribeRegional(describer.EbsVolumeMetricReadOpsHourly),
	"AWS::EC2::EbsVolumeMetricWriteOps":                               ParallelDescribeRegional(describer.EbsVolumeMetricWriteOps),
	"AWS::EC2::EbsVolumeMetricWriteOpsDaily":                          ParallelDescribeRegional(describer.EbsVolumeMetricWriteOpsDaily),
	"AWS::EC2::EbsVolumeMetricWriteOpsHourly":                         ParallelDescribeRegional(describer.EbsVolumeMetricWriteOpsHourly),
	...
	"AWS::CostExplorer::ByRecordTypeMonthly": SequentialDescribeGlobal(describer.CostByRecordTypeLastMonth),
	"AWS::CostExplorer::ByRecordTypeDaily":   SequentialDescribeGlobal(describer.CostByRecordTypeLastDay),
	"AWS::CostExplorer::ByUsageTypeMonthly":  SequentialDescribeGlobal(describer.CostByServiceUsageLastMonth),
	"AWS::CostExplorer::ByUsageTypeDaily":    SequentialDescribeGlobal(describer.CostByServiceUsageLastDay),
	"AWS::CostExplorer::ForcastMonthly":      SequentialDescribeGlobal(describer.CostForecastMonthly),
	"AWS::CostExplorer::ForcastDaily":        SequentialDescribeGlobal(describer.CostForecastDaily),
	...
	"AWS::EC2::AvailabilityZone":  SequentialDescribeGlobal(describer.EC2AvailabilityZone),
	...
	"AWS::EC2::TransitGatewayRoute":      ParallelDescribeRegional(describer.EC2TransitGatewayRoute),
	"AWS::EC2::TransitGatewayAttachment": ParallelDescribeRegional(describer.EC2TransitGatewayAttachment),
	"AWS::EC2::InstanceAvailability":     ParallelDescribeRegional(describer.EC2InstanceAvailability),
	"AWS::EC2::InstanceType":             ParallelDescribeRegional(describer.EC2InstanceType),
	"AWS::EC2::ManagedPrefixList":        ParallelDescribeRegional(describer.EC2ManagedPrefixList),
	"AWS::EC2::SpotPrice":                ParallelDescribeRegional(describer.EC2SpotPrice),
	...
	"AWS::ECR::Image":      ParallelDescribeRegional(describer.ECRImage),
	...
	"AWS::ECS::Task":              ParallelDescribeRegional(describer.ECSTask),
	...
	"AWS::EKS::FargateProfile": ParallelDescribeRegional(describer.EKSFargateProfile),
	"AWS::EKS::AddonVersion":   ParallelDescribeRegional(describer.EKSAddonVersion),
	...
	// "AWS::ElasticBeanstalk::Platform":           ParallelDescribeRegional(describer.ElasticBeanstalkPlatform), // Limit reached
	...
	"AWS::ElastiCache::ParameterGroup":                                            ParallelDescribeRegional(describer.ElastiCacheParameterGroup),
	"AWS::ElastiCache::ReservedCacheNode":                                         ParallelDescribeRegional(describer.ElastiCacheReservedCacheNode),
	"AWS::ElastiCache::SubnetGroup":                                               ParallelDescribeRegional(describer.ElastiCacheSubnetGroup),
	...
	"AWS::ElasticLoadBalancingV2::SslPolicy":                                      ParallelDescribeRegional(describer.ElasticLoadBalancingV2SslPolicy),
	"AWS::ElasticLoadBalancingV2::ApplicationLoadBalancerMetricRequestCount":      ParallelDescribeRegional(describer.ApplicationLoadBalancerMetricRequestCount),
	"AWS::ElasticLoadBalancingV2::ApplicationLoadBalancerMetricRequestCountDaily": ParallelDescribeRegional(describer.ApplicationLoadBalancerMetricRequestCountDaily),
	"AWS::ElasticLoadBalancingV2::NetworkLoadBalancerMetricNetFlowCount":          ParallelDescribeRegional(describer.NetworkLoadBalancerMetricNetFlowCount),
	"AWS::ElasticLoadBalancingV2::NetworkLoadBalancerMetricNetFlowCountDaily":     ParallelDescribeRegional(describer.NetworkLoadBalancerMetricNetFlowCountDaily),
	...
	"AWS::EMR::Instance":                                                          ParallelDescribeRegional(describer.EMRInstance),
	"AWS::EMR::InstanceFleet":                                                     ParallelDescribeRegional(describer.EMRInstanceFleet),
	"AWS::EMR::InstanceGroup":                                                     ParallelDescribeRegional(describer.EMRInstanceGroup),
	"AWS::EventBridge::EventBus":                                                  ParallelDescribeRegional(describer.EventBridgeBus),
	"AWS::EventBridge::EventRule":                                                 ParallelDescribeRegional(describer.EventBridgeRule),
	...
	"AWS::GuardDuty::Filter":                                                      ParallelDescribeRegional(describer.GuardDutyFilter),
	"AWS::GuardDuty::IPSet":                                                       ParallelDescribeRegional(describer.GuardDutyIPSet),
	"AWS::GuardDuty::Member":                                                      ParallelDescribeRegional(describer.GuardDutyMember),
	"AWS::GuardDuty::PublishingDestination":                                       ParallelDescribeRegional(describer.GuardDutyPublishingDestination),
	"AWS::GuardDuty::ThreatIntelSet":                                              ParallelDescribeRegional(describer.GuardDutyThreatIntelSet),
	...
	"AWS::IAM::PolicyAttachment":          SequentialDescribeGlobal(describer.IAMPolicyAttachment),
	"AWS::IAM::SamlProvider":              SequentialDescribeGlobal(describer.IAMSamlProvider),
	"AWS::IAM::ServiceSpecificCredential": SequentialDescribeGlobal(describer.IAMServiceSpecificCredential),
	...
	"AWS::ApiGateway::ApiKey":             ParallelDescribeRegional(describer.ApiGatewayApiKey),
	"AWS::ApiGateway::UsagePlan":          ParallelDescribeRegional(describer.ApiGatewayUsagePlan),
	"AWS::ApiGateway::Authorizer":         ParallelDescribeRegional(describer.ApiGatewayAuthorizer),
	"AWS::ApiGatewayV2::Api":              ParallelDescribeRegional(describer.ApiGatewayV2API),
	"AWS::ApiGatewayV2::DomainName":       ParallelDescribeRegional(describer.ApiGatewayV2DomainName),
	"AWS::ApiGatewayV2::Integration":      ParallelDescribeRegional(describer.ApiGatewayV2Integration),
	...
	"AWS::KinesisAnalyticsV2::Application": ParallelDescribeRegional(describer.KinesisAnalyticsV2Application),
	...
	// "AWS::Shield::ProtectionGroup": ParallelDescribeRegional(describer.ShieldProtectionGroup), // Limit reached
	...
	"AWS::Account::AlternateContact":           ParallelDescribeRegional(describer.AccountAlternateContact),
	"AWS::Account::Contact":                    ParallelDescribeRegional(describer.AccountContact),
	"AWS::Amplify::App":                        ParallelDescribeRegional(describer.AmplifyApp),
	"AWS::AppConfig::Application":              ParallelDescribeRegional(describer.AppConfigApplication),
	"AWS::AuditManager::Assessment":            ParallelDescribeRegional(describer.AuditManagerAssessment),
	"AWS::AuditManager::Control":               ParallelDescribeRegional(describer.AuditManagerControl),
	"AWS::AuditManager::Evidence":              ParallelDescribeRegional(describer.AuditManagerEvidence),
	"AWS::AuditManager::EvidenceFolder":        ParallelDescribeRegional(describer.AuditManagerEvidenceFolder),
	"AWS::AuditManager::Framework":             ParallelDescribeRegional(describer.AuditManagerFramework),
	"AWS::CloudControl::Resource":              ParallelDescribeRegional(describer.CloudControlResource),
	"AWS::GlobalAccelerator::Accelerator":      ParallelDescribeRegional(describer.GlobalAcceleratorAccelerator),
	"AWS::GlobalAccelerator::Listener":         ParallelDescribeRegional(describer.GlobalAcceleratorListener),
	"AWS::GlobalAccelerator::EndpointGroup":    ParallelDescribeRegional(describer.GlobalAcceleratorEndpointGroup),
	"AWS::Glue::CatalogDatabase":               ParallelDescribeRegional(describer.GlueCatalogDatabase),
	"AWS::Glue::CatalogTable":                  ParallelDescribeRegional(describer.GlueCatalogTable),
	"AWS::Glue::Connection":                    ParallelDescribeRegional(describer.GlueConnection),
	"AWS::Glue::Crawler":                       ParallelDescribeRegional(describer.GlueCrawler),
	"AWS::Glue::DataCatalogEncryptionSettings": ParallelDescribeRegional(describer.GlueDataCatalogEncryptionSettings),
	"AWS::Glue::DataQualityRuleset":            ParallelDescribeRegional(describer.GlueDataQualityRuleset),
	"AWS::Glue::DevEndpoint":                   ParallelDescribeRegional(describer.GlueDevEndpoint),
	"AWS::Glue::Job":                           ParallelDescribeRegional(describer.GlueJob),
	"AWS::Glue::SecurityConfiguration":         ParallelDescribeRegional(describer.GlueSecurityConfiguration),
	"AWS::Health::Event":                       ParallelDescribeRegional(describer.HealthEvent),
	"AWS::IdentityStore::Group":                ParallelDescribeRegional(describer.IdentityStoreGroup),
	"AWS::IdentityStore::User":                 ParallelDescribeRegional(describer.IdentityStoreUser),
	"AWS::Inspector::AssessmentRun":            ParallelDescribeRegional(describer.InspectorAssessmentRun),
	"AWS::Inspector::AssessmentTarget":         ParallelDescribeRegional(describer.InspectorAssessmentTarget),
	"AWS::Inspector::AssessmentTemplate":       ParallelDescribeRegional(describer.InspectorAssessmentTemplate),
	"AWS::Inspector::Exclusion":                ParallelDescribeRegional(describer.InspectorExclusion),
	"AWS::Inspector::Finding":                  ParallelDescribeRegional(describer.InspectorFinding),
}
