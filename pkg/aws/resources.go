...
var ResourceTypeToDescriber = map[string]ResourceDescriber{
	...
	"AWS::IAM::AccessKey":                                         describer.IAMAccessKey, // Global
	...
	"AWS::IAM::User":                                              describer.IAMUser, // Global
	...
	"AWS::Route53::DNSSEC":                                        describer.Route53DNSSEC, // Global
	...
	"AWS::S3::Bucket":                                             describer.S3Bucket, // Global
	"AWS::S3::BucketPolicy":                                       describer.S3BucketPolicy, // Semi-Global
