...
var resourceTypeToDescriber = map[string]ResourceDescriber{
	...
	"AWS::Backup::BackupBackupRecoveryPoint":                      ParallelDescribeRegional(describer.BackupBackupRecoveryPoint),
	"AWS::Backup::BackupBackupProtectedResource":                  ParallelDescribeRegional(describer.BackupBackupProtectedResource),
	"AWS::Backup::BackupVault":                                    ParallelDescribeRegional(describer.BackupBackupVault),
	"AWS::CloudFront::Distribution":                               ParallelDescribeRegional(describer.CloudFrontDistribution),
