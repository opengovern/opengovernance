...
var awsMap = map[string]string{
	...
	"AWS::EC2::DHCPOptions":                     "aws_ec2_vpc_dhcp_options",
	"AWS::EC2::EgressOnlyInternetGateway":       "aws_ec2_vpc_egress_only_internet_gateway",
	"AWS::EC2::VPCPeeringConnection":            "aws_ec2_vpc_peering_connection",
	"AWS::EC2::SecurityGroupRule":               "aws_ec2_vpc_security_group_rule",
	...
	"AWS::ElasticLoadBalancingV2::Rule":         "aws_ec2_load_balancer_listener_rule",
...
var AWSDescriptionMap = map[string]interface{}{
	...
	"AWS::ElasticLoadBalancingV2::Rule":         &keibi.ElasticLoadBalancingV2Rule{},
